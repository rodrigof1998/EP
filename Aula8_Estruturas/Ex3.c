...
int main(void) 
{ 
	Time_t Entrada, Saida, diferenca;	
	Student_t Estudante1;
	
	printf("Introduza os dados do aluno.\n");
	Estudante1=ask_Student();
	...
	printf("O aluno esteve no DETI o seguinte tempo: ");
	diferenca=diference_Time(&Entrada, &Saida); 
	print(&diferenca);
